...
namespace IntegracionApi.Controllers
{
    ...
    {
        internal TipoComprobanteBl BusinessLogic = new TipoComprobanteBl();
        ...
        public HttpResponseMessage GetList()
        {
            try
            {
                var tipocomprobante = BusinessLogic.GetList();
                return Request.CreateResponse(HttpStatusCode.OK, tipocomprobante);
            }
            catch (Exception ex)
            {
