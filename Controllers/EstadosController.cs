...
namespace IntegracionApi.Controllers
{
    ...
    {
        internal EstadosBl BusinessLogic = new EstadosBl();
        ...
        [HttpGet]
        public HttpResponseMessage GetTotales(int? afiliadoId, DateTime? periodoIni, DateTime? periodoFin, int? estado, int? numeroEnvioAfip)
        {
            try
            {
                var resultado = BusinessLogic.GetTotales(afiliadoId ?? 0, periodoIni, periodoFin, estado, numeroEnvioAfip);
